...
impl AtaChannel {
    ...
    fn read8(&self, offset: usize) -> u8 {
        unsafe { crate::arch::legacy_port::Port::new(self.io_base + offset as u16).read() }
    }

    /// Performs the write8 operation.
    fn write8(&self, offset: usize, value: u8) {
        unsafe { crate::arch::legacy_port::Port::new(self.io_base + offset as u16).write(value) }
    }

    /// Performs the read16 operation.
    fn read16(&self) -> u16 {
        unsafe { crate::arch::legacy_port::Port::new(self.io_base).read() }
    }

    /// Performs the write16 operation.
    fn write16(&self, value: u16) {
        unsafe { crate::arch::legacy_port::Port::new(self.io_base).write(value) }
    }
