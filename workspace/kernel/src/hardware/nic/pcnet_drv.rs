...
impl Ports {
    ...
    fn read8(&self, offset: u16) -> u8 {
        unsafe {
            crate::x86_crate_shim::instructions::port::Port::new(self.io_base + offset).read()
        }
    }
    ...
    fn write8(&mut self, offset: u16, value: u8) {
        unsafe {
            crate::x86_crate_shim::instructions::port::Port::new(self.io_base + offset).write(value)
        }
    }
    ...
    fn write_rap(&mut self, val: u32) {
        unsafe {
            crate::x86_crate_shim::instructions::port::Port::new(self.io_base + 0x14).write(val)
        }
    }
    ...
    fn write_rdp(&mut self, val: u32) {
        unsafe {
            crate::x86_crate_shim::instructions::port::Port::new(self.io_base + 0x10).write(val)
        }
    }
    ...
    fn write_bdp(&mut self, val: u32) {
        unsafe {
            crate::x86_crate_shim::instructions::port::Port::new(self.io_base + 0x1C).write(val)
        }
    }
