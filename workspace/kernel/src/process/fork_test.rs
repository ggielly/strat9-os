...
use crate::{
    ...
    process::{
        ...
        current_task_id, try_wait_child, TaskId, TaskPriority, TaskState, WaitChildResult,
    },
};
...
const PROG_FORK_BASIC: &[u8] = &[
    ,
...
const PROG_WAIT_NOCHILD: &[u8] = &[
    0x48, 0x83, 0xEC, 0x10, 0x48, 0xC7, 0xC7, 0xFF, 0xFF, 0xFF, 0xFF, 0x48, 0x8D, 0x74, 0x24,
    0x08, 0x48, 0x31, 0xD2, 0x48, 0xC7, 0xC0, 0x36, 0x01, 0x00, 0x00, 0x0F, 0x05, 0x48, 0x83,
    0xF8, 0xF6, 0x75, 0x0C, 0x48, 0x31, 0xFF, 0x48, 0xC7, 0xC0, 0x2C, 0x01, 0x00, 0x00, 0x0F,
    0x05, 0x48, 0xC7, 0xC7, 0x02, 0x00, 0x00, 0x00, 0x48, 0xC7, 0xC0, 0x2C, 0x01, 0x00, 0x00,
    0x0F, 0x05, 0xF4, 0xEB, 0xFD,
];
...
const PROG_WAIT_WNOHANG: &[u8] = &[
    ,
];
...
const PROG_WAIT_INVALID: &[u8] = &[
    0x48, 0x83, 0xEC, 0x10, 0x48, 0x31, 0xFF, 0x48, 0x8D, 0x74, 0x24, 0x08, 0x48, 0x31, 0xD2,
    0x48, 0xC7, 0xC0, 0x36, 0x01, 0x00, 0x00, 0x0F, 0x05, 0x48, 0x83, 0xF8, 0xEA, 0x75, 0x0C,
    0x48, 0x31, 0xFF, 0x48, 0xC7, 0xC0, 0x2C, 0x01, 0x00, 0x00, 0x0F, 0x05, 0x48, 0xC7, 0xC7,
    0x04, 0x00, 0x00, 0x00, 0x48, 0xC7, 0xC0, 0x2C, 0x01, 0x00, 0x00, 0x0F, 0x05, 0xF4, 0xEB,
    0xFD,
];
...
extern "C" fn fork_test_main() -> ! {
    ...
    crate::serial_println!("[fork-test] wait nochild: {}", if s2 { "ok" } else { "FAIL" });

    let s3 = run_scenario(parent, "fork-test-wnohang", PROG_WAIT_WNOHANG);
    crate::serial_println!("[fork-test] wait wnohang: {}", if s3 { "ok" } else { "FAIL" });

    let s4 = run_scenario(parent, "fork-test-invalid", PROG_WAIT_INVALID);
    crate::serial_println!("[fork-test] wait invalid: {}", if s4 { "ok" } else { "FAIL" });
