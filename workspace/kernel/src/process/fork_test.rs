...
// Scenario 2:
// waitpid(-1, ...) with no child must return -ENOENT.
...
const PROG_WAIT_NOCHILD: &[u8] = &[
    ...
    0xF8, 0xFE, 0x75, 0x0C, 0x48, 0x31, 0xFF, 0x48, 0xC7, 0xC0, 0x2C, 0x01, 0x00, 0x00, 0x0F,
    0x05, 0x48, 0xC7, 0xC7, 0x02, 0x00, 0x00, 0x00, 0x48, 0xC7, 0xC0, 0x2C, 0x01, 0x00, 0x00,
    0x0F, 0x05, 0xF4, 0xEB, 0xFD,
];

// Scenario 3:
// fork + waitpid(WNOHANG) must return 0 before child exit, then blocking waitpid must reap.
...
const PROG_WAIT_WNOHANG: &[u8] = &[
    ...
    ,
];
