...
À la fin de ce lot, les autres constats restaient à traiter, notamment R06 (double conversion HHDM des modules), R09 (taille BSS fondée sur une marge de 8 Mio), R11 à R14 (transition CPU et couverture mémoire), ainsi que GOP et les attributs de cache. R09 à R14 ont depuis été traités par le [lot ordre 3](C:/src/strat9-os/doc/BOOTLOADER_ELF_TRANSITION_FIXES_2026-09-12.md). Ces corrections ne constituent pas une validation du démarrage complet.
